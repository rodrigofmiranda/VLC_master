...
class channel_dataset(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "channel_dataset_4qam", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("channel_dataset_4qam")
        ...
        self.blocks_file_sink_0_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/rodrigo/Documents/Amplificado/4QAM/received', False)
        self.blocks_file_sink_0_0.set_unbuffered(False)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/rodrigo/Documents/Amplificado/4QAM/sent', False)
        self.blocks_file_sink_0.set_unbuffered(False)
        self.analog_random_source_x_0 = blocks.vector_source_b(list(map(int, numpy.random.randint(0, 4, int(samples)))), True)
