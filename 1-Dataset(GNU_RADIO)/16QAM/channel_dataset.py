...
class channel_dataset(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "channel_dataset_16qam", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("channel_dataset_16qam")
        ...
        self.points_16qam = points_16qam = [ -0.7071-0.7071j, -0.7071-0.2357j, -0.7071+0.2357j, -0.7071+0.7071j, -0.2357-0.7071j, -0.2357-0.2357j, -0.2357+0.2357j, -0.2357+0.7071j, 0.2357-0.7071j,  0.2357-0.2357j,  0.2357+0.2357j,  0.2357+0.7071j,  0.7071-0.7071j,  0.7071-0.2357j,  0.7071+0.2357j,  0.7071+0.7071j]
        ...
        self.digital_chunks_to_symbols_xx_0 = digital.chunks_to_symbols_bc(points_16qam, 1)
        ...
        self.blocks_file_sink_0_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/rodrigo/Documents/Amplificado/16QAM/received', False)
        self.blocks_file_sink_0_0.set_unbuffered(False)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/rodrigo/Documents/Amplificado/16QAM/sent', False)
        self.blocks_file_sink_0.set_unbuffered(False)
        self.analog_random_source_x_0_0 = blocks.vector_source_b(list(map(int, numpy.random.randint(0, 16, int(samples)))), True)
    ...
    def get_points_16qam(self):
        return self.points_16qam

    def set_points_16qam(self, points_16qam):
        self.points_16qam = points_16qam
        self.digital_chunks_to_symbols_xx_0.set_symbol_table(self.points_16qam)
