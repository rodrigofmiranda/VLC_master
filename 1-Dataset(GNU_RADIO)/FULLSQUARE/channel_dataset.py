...
class channel_dataset(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("channel_dataset_full_square")
        ...
        self.blocks_file_sink_0_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/rodrigo/Documents/Amplificado/FULLSQUARE/received', False)
        self.blocks_file_sink_0_0.set_unbuffered(False)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/rodrigo/Documents/Amplificado/FULLSQUARE/sent', False)
        self.blocks_file_sink_0.set_unbuffered(False)
        self.analog_random_source_x_1 = blocks.vector_source_s(list(map(int, numpy.random.randint((-32767), 32767, int(samples)))), True)
        ...
        self.connect((self.blocks_interleaved_short_to_complex_0, 0), (self.qtgui_const_sink_x_1_0, 0))
